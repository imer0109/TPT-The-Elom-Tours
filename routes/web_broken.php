...
Route::prefix("admin")->middleware(["web", "auth", "check.role:Super Administrateur,Administrateur"])->group(function () {
    // Dashboard
...
// Ajouter ces routes dans le groupe admin

Route::middleware(['auth', 'role:Super Administrateur'])->group(function () {
    Route::get('/activity-logs', [ActivityLogController::class, 'index'])->name('admin.activity-logs.index');
    Route::get('/activity-logs/{id}', [ActivityLogController::class, 'show'])->name('admin.activity-logs.show');
});

R o u t e : : g e t ( " / t e s t - a u t h " ,   f u n c t i o n ( )   { 
         i f   ( A u t h : : c h e c k ( ) )   { 
                 r e t u r n   " U t i l i s a t e u r   c o n n e c t � :   "   .   A u t h : : u s e r ( ) - > e m a i l ; 
         }   e l s e   { 
                 r e t u r n   " U t i l i s a t e u r   n o n   c o n n e c t � " ; 
         } 
 } ) ; 
 
 