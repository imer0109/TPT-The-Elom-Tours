...
@section('title', 'Modifier un article - The Elom Tours')

@section('content')
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Modifier l'article</h1>
            <a href="{{ route('admin.blogs.index') }}" class="btn-secondary">
                <i class="fas fa-arrow-left mr-2"></i>Retour
            </a>
        </div>

        <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg overflow-hidden">
            @csrf
            @method('PUT')
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            <img src="{{ Storage::url($blog->featured_image) }}" alt="{{ $blog->title }}" class="h-32 w-32 object-cover rounded">
                        </div>
                        @endif
