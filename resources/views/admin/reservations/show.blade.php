...
<div class="container px-6 mx-auto grid">
        ...
        <div>
            <form action="{{ route('admin.reservations.change-status', $reservation) }}" method="POST" class="inline">
                ...
                <div class="flex items-center space-x-2">
                    <select name="statut" class="text-sm border-gray-300 rounded-md focus:border-blue-400 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
    ...
    <!-- Historique des paiements (à implémenter ultérieurement) -->
