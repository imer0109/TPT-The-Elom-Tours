...
@section('title', 'Modifier un circuit - The Elom Tours')
...
<div class="container mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold">Modifier le circuit</h1>
    </div>
        ...
        <form action="{{ route('admin.circuits.update', $circuit) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="titre" name="titre" value="{{ old('titre', $circuit->titre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    </div>
                    
                    <!-- Slug -->
                    <div>
                        <label for="slug" class="block text-sm font-medium text-gray-700 mb-1">Slug (URL) <span class="text-red-500">*</span></label>
                        <input type="text" id="slug" name="slug" value="{{ old('slug', $circuit->slug) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="destination" name="destination" value="{{ old('destination', $circuit->destination) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    </div>
                    
                    <!-- Durée -->
                    <div>
                        <label for="duree" class="block text-sm font-medium text-gray-700 mb-1">Durée (jours) <span class="text-red-500">*</span></label>
                        <input type="number" id="duree" name="duree" min="1" value="{{ old('duree', $circuit->duree) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    </div>
                    
                    <!-- Prix -->
                    <div>
                        <label for="prix" class="block text-sm font-medium text-gray-700 mb-1">Prix par personne (€) <span class="text-red-500">*</span></label>
                        <input type="number" id="prix" name="prix" min="0" step="0.01" value="{{ old('prix', $circuit->prix) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="difficulte" name="difficulte" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                            ...
                            <option value="facile" {{ old('difficulte', $circuit->difficulte) == 'facile' ? 'selected' : '' }}>Facile</option>
                            <option value="modere" {{ old('difficulte', $circuit->difficulte) == 'modere' ? 'selected' : '' }}>Modéré</option>
                            <option value="difficile" {{ old('difficulte', $circuit->difficulte) == 'difficile' ? 'selected' : '' }}>Difficile</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="taille_groupe" name="taille_groupe" min="1" value="{{ old('taille_groupe', $circuit->taille_groupe) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="langue_fr" name="langues[]" value="fr" {{ in_array('fr', old('langues', $circuit->langues)) ? 'checked' : '' }} class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary">
                                <label for="langue_fr" class="ml-2 text-sm font-medium text-gray-900">Français</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="langue_en" name="langues[]" value="en" {{ in_array('en', old('langues', $circuit->langues)) ? 'checked' : '' }} class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary">
                                <label for="langue_en" class="ml-2 text-sm font-medium text-gray-900">Anglais</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="langue_es" name="langues[]" value="es" {{ in_array('es', old('langues', $circuit->langues)) ? 'checked' : '' }} class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary">
                                <label for="langue_es" class="ml-2 text-sm font-medium text-gray-900">Espagnol</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="langue_de" name="langues[]" value="de" {{ in_array('de', old('langues', $circuit->langues)) ? 'checked' : '' }} class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary">
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="checkbox" id="est_actif" name="est_actif" value="1" {{ old('est_actif', $circuit->est_actif) ? 'checked' : '' }} class="sr-only peer">
            ...
            <div class="mb-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="6" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5" required>{{ old('description', $circuit->description) }}</textarea>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative inline-block">
                            <img src="{{ asset($circuit->image) }}" alt="{{ $circuit->titre }}" class="max-h-64 rounded-lg">
                        </div>
                    </div>
                    @endif
