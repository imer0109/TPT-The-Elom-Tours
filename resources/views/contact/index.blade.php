                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-3">
                                <a href="https://www.facebook.com/TheElomTour?mibextid=ZbWKwL" class="bg-blue-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-700">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                <a href="https://x.com/TheElomTours" class="bg-blue-400 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-500">
                                    <i class="fab fa-twitter"></i>
                                </a>
                                <a href="https://www.instagram.com/theelomtours/?next=%2F" class="bg-pink-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-pink-700">
                                    <i class="fab fa-instagram"></i>
                                </a>
                                <a href="https://www.linkedin.com/company/the-elom-tour/" class="bg-pink-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-pink-700">
                                    <i class="fab fa-linkedin"></i>
                                </a>
                                <a href="https://www.tiktok.com/@the.elom.tours?_r=1&_d=el7838ea2647db&sec_uid=MS4wLjABAAAAUznXkTlzlOSWU2DD8aJynYIbgBTA3w6UuajFprZkL67rbtwoNdY7h1i8NX82QhKm&share_author_id=7253058242740536326&sharer_language=fr&source=h5_m&u_code=e8m6c2ad0khhdc&timestamp=1757928672&user_id=7253058242740536326&sec_user_id=MS4wLjABAAAAUznXkTlzlOSWU2DD8aJynYIbgBTA3w6UuajFprZkL67rbtwoNdY7h1i8NX82QhKm&item_author_type=1&utm_source=copy&utm_campaign=client_share&utm_medium=android&share_iid=7549234641825679110&share_link_id=d3c1e50b-890e-4135-a2bc-dceaa80785aa&share_app_id=1233&ugbiz_name=ACCOUNT&ug_btm=b8727%2Cb7360&social_share_type=5&enable_checksum=1" class="bg-red-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-700">
